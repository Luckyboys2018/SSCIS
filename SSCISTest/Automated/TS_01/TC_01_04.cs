...
namespace SSCISTest.Automated.TS_01
{
    ...
    public class TC_01_04
    {
        ...
        public void TheTC0104Test()
        {
            ...
            new SelectElement(driver.FindElement(By.Id("Degree"))).SelectByText("3");
            driver.FindElement(By.Id("Degree")).Click();
            ...
            new SelectElement(driver.FindElement(By.XPath("(//select[@id='Degree'])[2]"))).SelectByText("3");
            driver.FindElement(By.XPath("(//select[@id='Degree'])[2]")).Click();
